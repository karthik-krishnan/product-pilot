export function generateStoriesTemplate({
  contextBlock,
  epicTitle,
  epicDescription,
  epicCategory,
  ...
  return `You are a senior product manager breaking down an epic into a complete, production-ready set of user stories for a real engineering team.
